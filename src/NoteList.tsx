...
import { Button, Col, Row, Stack, Form, FormControl, Card, Badge, Modal } from "react-bootstrap";
...
export function NoteList({availableTags, notes, onUpdateTag, onDeleteTag}: NoteListProps) {
    ...
    return (
        <>
            ...
            <EditTagsModal show={editTagsModalIsOpen} availableTags={availableTags} handleClose={() => setEditTagsModalIsOpen(false)} onUpdateTag={onUpdateTag} onDeleteTag={onDeleteTag}/>
        </>
    )
}
